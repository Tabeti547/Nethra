...
const AboutSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-24 lg:py-28 bg-gradient-subtle relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
          ...
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-nethra-navy mb-6">
            Pioneering the Future of Security
          </h2>
          <div className="w-24 h-1 bg-gradient-professional mx-auto mb-8 rounded-full"></div>
        ...
        {/* Stats section */}
        <div className={`grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 bg-gradient-professional rounded-2xl flex items-center justify-center shadow-premium hover:shadow-premium-lg transition-all duration-300 hover:scale-110">
                <stat.icon className="w-8 h-8 text-white" />
              </div>
              <div className="text-2xl md:text-3xl font-bold text-nethra-navy mb-2">{stat.value}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`space-y-8 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
            <div className="space-y-6">
              <h3 className="text-2xl md:text-3xl font-bold text-nethra-navy">
                Redefining Security Excellence
              </h3>
              
              <div className="space-y-5 text-nethra-gray leading-relaxed">
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
            <Card className="p-6 shadow-premium hover:shadow-premium-lg transition-all duration-300 hover-lift border-0 bg-gradient-to-br from-white to-nethra-light/30 rounded-2xl">
              ...
              <CardContent className="p-0">
                <p className="text-nethra-gray mb-4 leading-relaxed text-sm">
                  To empower clients with superior security by seamlessly integrating human 
                  expertise with advanced technology.
                </p>
                <Link to="/about" className="text-nethra-accent hover:text-nethra-navy font-semibold transition-colors inline-flex items-center gap-1 text-sm">
                  Read More <span>→</span>
                </Link>
              </CardContent>
            </Card>
            ...
            <Card className="p-6 shadow-premium hover:shadow-premium-lg transition-all duration-300 hover-lift border-0 bg-gradient-to-br from-nethra-navy/5 to-nethra-blue/5 rounded-2xl">
              <Settings className="w-12 h-12 text-nethra-accent mb-4" />
              <h4 className="font-bold text-lg mb-3 text-nethra-navy">Technology</h4>
              <p className="text-nethra-gray text-sm">Advanced technology-driven security solutions for modern challenges</p>
            </Card>

            <Card className="p-6 shadow-premium hover:shadow-premium-lg transition-all duration-300 hover-lift border-0 bg-gradient-to-br from-nethra-accent/5 to-blue-500/5 rounded-2xl">
              <Users className="w-12 h-12 text-nethra-navy mb-4" />
              <h4 className="font-bold text-lg mb-3 text-nethra-navy">Expertise</h4>
              <p className="text-nethra-gray text-sm">Seasoned security professionals with industry-leading experience</p>
            </Card>
          </div>
        </div>
      </div>
